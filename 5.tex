...
\[\begin{split}
    16x^6-\frac{1}{4}&=\frac{1}{4}(64x^6-1)\\
    &=\frac{1}{4}\left[(8x^3)^2-1\right]\\
    &=\frac{1}{4}(8x^3+1)(8x^3-1)\\
    &=\frac{1}{4}(2x+1)(4x^2-2x+1)(2x-1)(4x^2+2x+1)
\end{split}\]
\end{solution}
...
同样，一元三次方程，也可以写成：
\[x^3-(x_1+x_2+x_3)x^2+(x_1x_2+x_1x_3+x_2x_3)x
-x_1 x_2 x_3=0\]
...
\item 已知$2x^3-6x^2+8=0$的三根是$\alpha,\beta,
\gamma$．试求以下各式的值：
\begin{multicols}{2}
    \begin{enumerate}
